...
#define CONTROL_DEFAULT_POS_KP            4.0f
#define CONTROL_DEFAULT_POS_KI            1.5f
#define CONTROL_DEFAULT_POS_RANGE_RPM     500.0f
#define CONTROL_DEFAULT_POS_ERR_DEG       0.2f

#define CONTROL_DEFAULT_VEL_KP            0.4f
#define CONTROL_DEFAULT_VEL_KI            0.8f
#define CONTROL_DEFAULT_VEL_RANGE_PWM     100.0f
#define CONTROL_DEFAULT_VEL_ERR_RPM       1.0f
 ...
 */
#define CONTROL_PRESET1_POS_KP            2.75f
#define CONTROL_PRESET1_POS_KI            0.2f
#define CONTROL_PRESET1_VEL_KP            2.25f
#define CONTROL_PRESET1_VEL_KI            0.05f

#define CONTROL_PRESET2_POS_KP            5.0f
#define CONTROL_PRESET2_POS_KI            1.75f
#define CONTROL_PRESET2_VEL_KP            0.1f
#define CONTROL_PRESET2_VEL_KI            1.0f
